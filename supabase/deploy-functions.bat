@echo off
REM Set your Supabase project ID - replace with your actual project ID
...
REM Set the environment variables for email and app configuration
...
REM Set the APP_BASE_URL environment variable for the meeting-response function
echo Setting environment variables...
supabase secrets set APP_BASE_URL="https://your-app-url.com" --project-ref %PROJECT_ID%
